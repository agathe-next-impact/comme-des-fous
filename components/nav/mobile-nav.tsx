  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="pr-0">
        <SheetHeader>
          <SheetTitle className="text-left" style={{ fontFamily: 'Host Grotesk, sans-serif' }}>
            <MobileLink
              href="/"
        ...
        <ScrollArea className="my-4 h-[calc(100vh-8rem)] pb-10 pl-6">
          <div className="flex flex-col space-y-3">
            <h3 className="text-small mt-6" style={{ fontFamily: 'Host Grotesk, sans-serif' }}>Menu</h3>
            <Separator />
            ...
            <h3 className="text-small pt-6" style={{ fontFamily: 'Host Grotesk, sans-serif' }}>Blog Menu</h3>
            <Separator />
